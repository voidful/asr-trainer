...
def parse_args(args):
    ...
    parser.add_argument("--train_set", default='mozilla-foundation/common_voice_11_0', type=str)
    parser.add_argument("--train_subset", type=str)
    parser.add_argument("--train_split", type=str)
    parser.add_argument("--test_set", default='mozilla-foundation/common_voice_11_0', type=str)
